...
If you use ddigitize in your work, please cite the software via Zenodo:

> Lindroos, R., & Hellgren Kotaleski, J. (2026). *ddigitize* (v1.0.0). Zenodo. https://doi.org/10.5281/zenodo.22687235

A manuscript describing the tool is currently in preparation. This section will be updated with the journal reference once published.
